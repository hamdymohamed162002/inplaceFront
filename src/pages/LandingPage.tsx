...
export function LandingPage() {
  ...
  useEffect(() => {
    fetch('https://inplace.onrender.com' + '/offers/all', {
      headers: {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 min-h-[600px] gap-10">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-xl my-5">
            Inplace is a platform that connects people looking for a place to stay with people
            offering a place to stay.
          </p>
          <Link to="/search">
            <Button>Find Place Now</Button>
          </Link>
        </div>
      </div>
